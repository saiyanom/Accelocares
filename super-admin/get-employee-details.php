<?php
	...
	if(isset($_GET['id']) && !empty($_GET['id'])){
		...
		if (strpos($company->emp_name_2, $_GET['id']) !== FALSE) {
			if($_GET['type'] == 'mobile'){
		...
		if (strpos($company->emp_name_3, $_GET['id']) !== FALSE) {
			if($_GET['type'] == 'mobile'){
		...
		if (strpos($company->emp_name_4, $_GET['id']) !== FALSE) {
			if($_GET['type'] == 'mobile'){
		...
		if (strpos($company->emp_name_5, $_GET['id']) !== FALSE) {
			if($_GET['type'] == 'mobile'){
