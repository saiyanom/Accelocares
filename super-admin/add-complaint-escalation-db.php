<?php 	
	...
	$comp_escalation 	= new ComplaintEscalation();
	$auth_emp 			= ComplaintEscalation::authenticate_emp_role($_GET['id'],$_POST['role_priority']);

	if($auth_emp){
		$session->message($auth_emp->emp_name. " Already Registered as ".$_POST['role_priority']);
		redirect_to("complaint-escalation.php?id=".$_GET['id']);
	}
