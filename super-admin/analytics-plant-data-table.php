...
<head>
<meta charset="utf-8" />
<title>Plant Data | Mahindraaccelo</title>
...
<div class="card-body">
<div class="al-com">
<div class="compl-lef"><h4>Plant Data</h4></div>
...
<?php
	...
	foreach($site_location as $site_location){
		if($repeat != $site_location->site_location){
			...
			foreach($complaint as $complaint){   
				...
				if($complaint->status == "Closed" && $complaint->plant_location == $site_location->site_location){
	...
	<?php $repeat = $site_location->site_location;} $total_total_complaint_tat += $total_complaint_tat; $total_average_complaint_tat += $average_complaint_tat; } ?>
</tbody>	
<tfoot>
	<tr>
