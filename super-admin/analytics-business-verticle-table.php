			...
			foreach($site_location as $site_location){
				if($repeat != $site_location->site_location){
					...
					foreach($complaint as $complaint){   
						...
						if($complaint->identify_source == "Mill" && $complaint->plant_location == $site_location->site_location){
							$total_total_complaint_received++;
						}

						if($complaint->identify_source == "Mill" && $complaint->status == "Closed" && $complaint->plant_location == $site_location->site_location){
