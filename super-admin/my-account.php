			...
			<div class="card">
				<div class="card-body profile-user-box">
						...
						<div class="col-sm-8">
							<div class="media">
								<div class="media-body">
									<h4 class="mt-1 mb-1"><?php echo $super_admin->admin_name;?></h4>
								</div> <!-- end media-body-->
							</div>
						</div> <!-- end col-->
					...
					<div class="text-left">
						...
						<p class="text-muted">
							<strong>MOBILE :</strong><span class="ml-2"><?php echo $super_admin->admin_mobile;?></span>
							&nbsp; &nbsp; <i data-toggle="modal" data-target="#edit_mobile" title="Edit Mobile Number" class="mdi mdi-square-edit-outline text-success"></i>
						</p>

						<p class="text-muted"><strong>EMAIL :</strong> <span class="ml-2"><?php echo $super_admin->admin_email;?></span></p>
        		...
        		<div class='row'>
					<div class='col-12 cldt-box'>
						<div class='form-group'><label class='control-label'>Mobile Number</label>
							<input type='text' id="mobile" placeholder='' name='mobile' value='<?php echo $super_admin->admin_mobile;?>' class="form-control"/>
