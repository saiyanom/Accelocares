        ...
        <form action="<?php echo "approve-approval-note-db.php?id=" . $approval_note->complaint_id; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-p-box form-p-box-bg2">
                ...
                <div class="rst-full">
                    ...
                    <ul class="fpall">
                        <li class="fp-con01">
                          <p>Debit note (purchase price/t) / Salvage rate / Sale value <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->debit_salvage_sale_txt; ?>" class="form-control form-p-box-bg2 sphf" name="debit_salvage_sale_txt"></p></li> 
                        <li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
                        <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->debit_note_sal_rate_sale_value; ?>" name="debit_note_sal_rate_sale_value" class="form-control form-p-box-bg2 sphf app_note_number" id="debit_note_sal_rate_sale_value"></li>
                        <div class="clerfix"></div>
                    </ul>
                ...
                <?php show_approver_info_common($complaint,$approval_note); ?>
                <div class="pfot-cont">
                    <p>
                        Note<br />
            ...
            <?php 
              ...
              if($readonly == ''){ ?>
                  ...
                  <div class='form-p-box form-p-boxbtn'>
                      ...
                      <input type='submit' id='approve_approval_note' name='approve_approval_note' class='fpdone' value='Submit' />
                  </div>
            <?php 
              }
            ?>
...
<script>
    ...
    function updateInputValue(){
        ...
        console.log( credit_note_iss_cust );
