...
<table id="basic-datatable" class="table dt-responsive basic-datatable" width="100%">
	...
	<tbody>
		...
		if(isset($_GET['company'])){
			...
			//echo $num."<hr />";
			if($num > 0){
				$comp_sql = "Select * from complaint where approval_note != '' AND {$company} {$date_range} {$department} {$complaint_type} {$sub_complaint_type} {$identify_source} date_ != '0000-00-00' ";
