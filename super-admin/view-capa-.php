<?php 
	...
	foreach ($_POST as $key => $value) {
		if (preg_match('/[\'"\^*()}!{><;`=]/', $value)){
			$session->message("Remove Special Character from View CAPA Page"); redirect_to("capa-approval.php");
		} 
	}
	...
	if(isset($_GET['data-type']) && !empty($_GET['data-type']) && isset($_GET['data-id']) && !empty($_GET['data-id'])){
	    if($_GET['data-type'] == 'w'){
