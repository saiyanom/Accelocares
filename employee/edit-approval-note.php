...
/*if ($approval_note->creator_id == $session->employee_id) {
    $readonly = "";
    $disabled = "";
} else {
    $readonly = "readonly";
...
<div class="modal-header border-bottom-st d-block">
    ...
    <div class="form-p-block" id="edit-note">
        <form action="<?php echo "raised-complaint-db.php?id=".$approval_note->complaint_id; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-p-box form-p-box-bg1 border-bottom-st">
                ...
                <div class="rst-right">
                    <ul class="fpall">
                        ...
                        <li class="fp-con2"><input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->total_qty_rejc; ?>" id="total_qty_rejc"  class="form-control form-p-box-bg2 app_note_number"></li>

                        <input type="hidden" name="total_qty_rejc" value="" id="total_qty_rejc-new">
                        <input type="hidden" name="total_qty_rejc_type" value="" id="total_qty_rejc_type">
            ...
            <div class="form-p-box form-p-box-bg2">
                ...
                <div class="rst-full">
                    ...
                    <ul class="fpall">
                        ...
                        <li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp;</span>
                            <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_acpt_steel_mill; ?>" id="qty_acpt_steel_mill"  class="form-control form-p-box-bg1 sphf app_note_number">
                        </li>
                        <div class="clerfix"></div>
                    </ul>
                    <ul class="fpall">
                        ...
                        <li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp;</span>
                            <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_scrp_auc_serv_cent; ?>" id="qty_scrp_auc_serv_cent"  class="form-control form-p-box-bg1 sphf app_note_number">
                        </li>
                        <div class="clerfix"></div>
                    </ul>
                    <ul class="fpall">
                        ...
                        <li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp;</span>
                            <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_dlv_customer; ?>" id="qty_dlv_customer"  class="form-control form-p-box-bg1 sphf app_note_number">
                        </li>
                        <div class="clerfix"></div>
                    </ul>
                    <ul class="fpall">
                ...
                <div class="rst-full">
                    <ul class="fpall">
                        ...
                        <textarea class="form-control mrig10 form-p-box-bg1" id="verify_remark" name="verify_remark" placeholder="Remarks" rows="3"><?php echo $approval_note->remark; ?></textarea>
                ...
                <?php 
                  ...
                  if($approver_info){
                    echo '
                        <div class="rst-full approver_info">
                            <hr>
                            <ul class="fpall">
            ...
            <input type="hidden" name="qty_acpt_steel_mill" value="" id="qty_acpt_steel_mill-new">
              <input type="hidden" name="qty_acpt_steel_mill_type" value="" id="qty_acpt_steel_mill_type">

              <input type="hidden" name="qty_scrp_auc_serv_cent" value="" id="qty_scrp_auc_serv_cent-new">
              <input type="hidden" name="qty_scrp_auc_serv_cent_type" value="" id="qty_scrp_auc_serv_cent_type">

              <input type="hidden" name="qty_dlv_customer" value="" id="qty_dlv_customer-new">
              <input type="hidden" name="qty_dlv_customer_type" value="" id="qty_dlv_customer_type">
...
<script>
    ...
    function updateInputValue(){
        ...
        $('#total_qty_rejc-new').val($.trim(temp_arr[0]));
        $('#total_qty_rejc_type').val($.trim(temp_arr[1]));
        ...
        $('#qty_acpt_steel_mill-new').val($.trim(temp_arr[0]));
        $('#qty_acpt_steel_mill_type').val($.trim(temp_arr[1]));
        ...
        $('#qty_scrp_auc_serv_cent-new').val($.trim(temp_arr[0]));
        $('#qty_scrp_auc_serv_cent_type').val($.trim(temp_arr[1]));
        ...
        $('#qty_dlv_customer-new').val($.trim(temp_arr[0]));
        $('#qty_dlv_customer_type').val($.trim(temp_arr[1]));
    ...
    $('#edit-note input').change(function() {
        updateInputValue();
    });

    $('#edit-note input').blur(function() {
        if ($(this).attr('type') == "number") {
            if (!$(this).val()) {
                $(this).val(0);
            }
