...
<ul class="rais-block">
	<li class="resit-act1">
	<select id="product" name="product" class="form-control select2" data-toggle="select2">
	...
	<div class="row">	
		...
		<div class="col col-sm-7">
			<input type="text" id="rejected_quantity" name="rejected_quantity" placeholder="Add Rejected Qty" class="form-control">
		</div>
