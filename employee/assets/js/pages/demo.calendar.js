! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        var i = e("<form></form>");
        i.append("<div class='row'></div>"), i.find(".row").append("<div class='col-12 cldt-box'><div class='form-group'><label class='control-label'>Meeting Date</label><input class='form-control' placeholder='' type='text' name='title'/></div></div>")
		.append("<div class='col-12 cldt-box'><div class='form-group'><label class='control-label'>Place</label><input class='form-control' placeholder=' ' type='text' name='title'/></div></div>")
		.append("<div class='col-12 cldt-box'><div class='form-group'><label class='control-label'> Customer Coordinator (whom to meet)</label><input class='form-control' placeholder=' ' type='text' name='title'/></div></div>")
		.append("<div class='col-12 cldt-box'><div class='form-group'><label class='control-label'>Mobile Number</label><input class='form-control' placeholder=' ' type='text' name='title'/></div></div>")
		.append("<div class='col-12 cldt-box'><div class='form-group'><label class='control-label'>Email ID</label><input class='form-control' placeholder=' ' type='text' name='title'/></div></div>")
