...
<?php       
    ...
    foreach($mill_reg as $mill_reg){    
        if(isset($_GET['from_date']) && !empty($_GET['from_date']) && isset($_GET['to_date']) && !empty($_GET['to_date'])){
            $mill_count = Complaint::count_by_mill_emp_date($_GET['from_date'], $_GET['to_date'], $mill_reg->mill_name,$session->employee_id);
        } else { $mill_count = Complaint::count_by_mill_emp($mill_reg->mill_name,$session->employee_id); }
