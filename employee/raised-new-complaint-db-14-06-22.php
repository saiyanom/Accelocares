...
<?php
	...
	if($complaint->save()) {
		...
		$mail->addCC($location_emp_email, $location_emp_name); 
		...
		<p><a style=' text-decoration:none; color:#1774b5' href='https://www.accelokonnect.com/crm/customer/'>https://www.accelokonnect.com/crm/customer/</a></p> 
		...
		$mail->Subject = "{$complaint->business_vertical} | {$complaint->plant_location} | Complaint ID #{$ticket_no} | {$complaint->company_name} | {$complaint->complaint_type}";
