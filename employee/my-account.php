			...
			<div class="card">
				<div class="card-body profile-user-box">
						...
						<div class="col-sm-8">
							<div class="media">
								<div class="media-body">
									<h4 class="mt-1 mb-1"><?php echo $employee->emp_name;?></h4>
								</div> <!-- end media-body-->
							</div>
						</div> <!-- end col-->
					...
					<div class="text-left">
						...
						<p class="text-muted">
							<strong>MOBILE :</strong><span class="ml-2"><?php echo $employee->emp_mobile;?></span>
							&nbsp; &nbsp; <i data-toggle="modal" data-target="#edit_mobile" title="Edit Mobile Number" class="mdi mdi-square-edit-outline text-success"></i>
						</p>

						<p class="text-muted"><strong>EMAIL :</strong> <span class="ml-2"><?php echo $employee->emp_email;?></span></p>

						<p class="text-muted"><strong>LOCATION :</strong> <span class="ml-2"><?php echo $employee->location;?></span></p>

						<p class="text-muted"><strong>ROLE :</strong> <span class="ml-2"><?php echo $employee->emp_role; ?></span></p>

						<!-- Danger Switch-->
						
						<input type="checkbox" id="emp_leave" <?php
							if($employee->emp_leave == "Active"){
								echo "Checked";
							} else { echo "";}
						?> data-switch="success"/>
						<label for="emp_leave" data-on-label="Active" data-off-label="Deactive"></label>
		...
		<div class="modal-content modal-filled bg-success">
			<div class="modal-body p-4">
				<div class="text-center">
					...
					<p class="mt-3" style="font-size:18px;"></p>
