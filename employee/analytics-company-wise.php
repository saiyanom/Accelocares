...
<?php 
	...
	foreach($company_reg as $company_reg){
		if(isset($_GET['from_date']) && !empty($_GET['from_date']) && isset($_GET['to_date']) && !empty($_GET['to_date'])){
			$company_reg_ = Complaint::count_by_company_reg_emp_date($_GET['from_date'], $_GET['to_date'], $company_reg->company_name,$session->employee_id);
		} else { $company_reg_ = Complaint::count_by_company_reg_emp($company_reg->company_name,$session->employee_id); }
		//echo "{$company_reg_},";
