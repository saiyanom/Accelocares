<?php 
    ...
    SimpleSAML_Session::getSessionFromRequest()->cleanup();
      ...
      if(! isset($attributes['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn'][0])){
          die('SSO : Email not returned');
      }

			$user_email = $attributes['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn'][0];
	    ...
	    $message = "";
			...
			if (isset($user_email)) { // Form has been submitted.
				...
				if ($found_admin) {
					...
					setcookie("PHPSESSID",$gen_cookie,time()+3600,"/administrator","",true,true);
