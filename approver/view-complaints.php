...
<div class="onlock" <?php if($complaint_reg->complaint_accepted != "Yes"){echo "style='display:none'";} ?>>
	...
	<div id="approval_action_taken_2" <?php if(empty($complaint_reg->approval_action_taken)){echo "style='display:none;'";}?>>
		...
		<div class="lrbox2"><a data-toggle="modal" data-backdrop="static" data-keyboard="false"class="view_approval_note" data-id="<?php echo $complaint_reg->approval_note; ?>" data-target="#view-approval-note" href="#">View</a>
		...
		?>>
			...
			<div class="onlock-2" <?php if($complaint_reg->create_approval_note == "Yes"){echo "style='display:none;'";} ?>>
				<div class="custom-control custom-checkbox arsalin">
					<input type="checkbox" disabled <?php if(!empty($complaint_reg->capa) || !empty($complaint_reg->capa_document)){echo "Checked";} ?> class="custom-control-input" id="capa_check">
