...
<tr class="row37">  
  ...
  <td colspan="2"><strong>{$complaint->emp_name}</strong></td>

  <td colspan="4"><strong>{$complaint->capa_qa_name}</strong></td>

  <td><strong>{$complaint->capa_ph_name}</strong></td>

  <td colspan="4">{$complaint->capa_pc_name}</td>

  <td colspan="4">{$complaint->capa_mr_name}</td>
