<?php
	...
	$emp_sql = "Select * from employee_location where product_id = '{$product_id->id}' AND emp_id = '{$employee_reg->id}' AND emp_sub_role != 'Employee' AND emp_sub_role != 'Viewer' AND emp_sub_role IN ('CRM - Head', 'Commercial Head', 'Plant Chief - AN', 'Sales Head', 'CFO', 'MD' )";

	$emp_location = EmployeeLocation::find_by_sql($emp_sql);
	foreach($emp_location as $emp_location){
		//echo $emp_location->emp_name." {$emp_location->emp_sub_role}<br /> "; 
		$emp_sub_role_appr = $emp_location->emp_sub_role;
	}
	...
	if($emp_sub_role_appr == "CRM - Head"){
		if(empty($complaint_reg->cna_crm_head)){ $readonly = ""; $disabled = ""; } else { $readonly = "readonly"; $disabled = "disabled"; }
	} 
...
<div class="form-p-box form-p-box-bg1 border-bottom-st">
	...
	<ul class="fpall">
		...
		<li class="fp-con2">
			<input <?php echo $readonly; ?> style="width: 100%;" id="billing_doc_date" value="<?php echo date( 'd-m-Y', strtotime($approval_note->billing_doc_date));  ?>" type="text" name="billing_doc_date" class="form-control fodhf date" data-provide="datepicker" data-toggle="date-picker" data-single-date-picker="true">
		</li>
		<div class="clerfix"></div>
	</ul>
</div>
...
<div class="rst-full">
	<ul class="fpall">
		<li class="fp-con01"><p>Basic sale price <input name="basic_sale_price_txt" <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->basic_sale_price_txt; ?>" class="form-control optional_field"></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->basic_sale_price; ?>" id="basic_sale_price" name="basic_sale_price" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Sales Value (Basic sale price/t X Qty) <span style="float: right;">(a)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->sales_value; ?>" id="sales_value" name="sales_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="text" name="cgst_percent" class="form-control cgst" value="<?php 
					...
					//echo 100 / ($approval_note->sales_value/$approval_note->cgst); 
				?>">
				<div class="input-group-append">
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->cgst; ?>" id="cgst" name="cgst" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="text" name="sgst_percent" class="form-control sgst" value="<?php 
					...
					//echo 100 / ($approval_note->sales_value/$approval_note->sgst); 
				?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->sgst; ?>" id="sgst" name="sgst" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Cost incurred by the customer, <input <?php echo $readonly; ?> type="text" name="cost_inc_customer_txt" value="<?php echo $approval_note->cost_inc_customer_txt; ?>" class="form-control optional_field"></p></li> 
		<li class="fp-con02"><span class="padd10">(+) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->cost_inc_customer; ?>" id="cost_inc_customer" name="cost_inc_customer" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Salvage Rate <input <?php echo $readonly; ?> name="salvage_value_txt" type="text" value="<?php echo $approval_note->salvage_value_txt; ?>" class="form-control optional_field"></p></li> 
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->salvage_value; ?>" id="salvage_value" name="salvage_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->credit_note_iss_cust; ?>" id="credit_note_iss_cust" name="credit_note_iss_cust" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
</div>
...
<div class="rst-full">
	...
	<ul class="fpall">
		...
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_acpt_steel_mill; ?>" id="qty_acpt_steel_mill" name="qty_acpt_steel_mill" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Quantity (t) to be scrapped / auction at service centres </p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>  
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_scrp_auc_serv_cent; ?>" id="qty_scrp_auc_serv_cent" name="qty_scrp_auc_serv_cent" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Quantity (t) to be diverted to any other customer</p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;`</span>  
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->qty_dlv_customer; ?>" id="qty_dlv_customer" name="qty_dlv_customer" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Debit note (purchase price/t) / Salvage rate / Sale value <input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->debit_salvage_sale_txt; ?>" class="form-control optional_field"></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->debit_note_sal_rate_sale_value; ?>" id="debit_note_sal_rate_sale_value" name="debit_note_sal_rate_sale_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Value (purchase price/t  X qty) <span style="float: right;">(b)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->value; ?>" id="value" name="value" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="text" name="lcgst_percent" class="form-control loss_cgst" value="<?php 
					...
					//echo 100 / ($approval_note->value/$approval_note->loss_cgst); 
				?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->loss_cgst; ?>" id="loss_cgst" name="loss_cgst" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="text" name="lsgst_percent" class="form-control loss_sgst" value="<?php 
					...
					//echo 100 / ($approval_note->value/$approval_note->loss_sgst); 
				?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->loss_sgst; ?>" id="loss_sgst" name="loss_sgst" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Total Debit Value  <span style="float: right;">(x)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->total_debit_value; ?>" id="total_debit_value" name="total_debit_value" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<p>Other expenses incurred by MIL  <input style="width: 300px;" <?php echo $readonly; ?> type="text" value="<?php echo $approval_note->other_exp_inc_mill_txt; ?>" class="form-control optional_field"> <span style="float: right;">(c)</span></p>
		</li> 
		<li class="fp-con02"><span class="padd10">(+) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->oth_exp_inc_mill; ?>" id="oth_exp_inc_mill" name="oth_exp_inc_mill" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->oth_exp_debited; ?>" id="oth_exp_debited" name="oth_exp_debited" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Compensation expected from Insurance Co. <span style="float: right;">(d)</span></p></li> 
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->compensation_exp; ?>" id="compensation_exp" name="compensation_exp" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->debit_note_iss_supplier; ?>" id="debit_note_iss_supplier" name="debit_note_iss_supplier" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p class="colrred">Loss from the Rejection <span style="float: right;">(e) = (a-b+c-d-y)</span></p></li> 
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->loss_from_rejection; ?>" id="loss_from_rejection" name="loss_from_rejection" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Recoverable from Transporter (if applicable) <span style="float: right;">(f)</span></p></li> 
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->recoverable_transporter; ?>" id="recoverable_transporter" name="recoverable_transporter" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p class="colrred">Net Loss / (-) Net Profit <span style="float: right;">(e-f)</span></p></li> 
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="text"  value="<?php echo $approval_note->net_loss; ?>" id="net_loss" name="net_loss" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
...
<div class="rst-full">
	<ul class="fpall">
		<div class="custom-control custom-checkbox arsalin">
			<input name="cna_md_status" <?php if($approval_note->net_loss >= 100000){echo " checked "; } ?> type="checkbox" class="custom-control-input" id="cna_crm_head">
...
<div class="rst-full">
	...
	<ul class="fpall" <?php if($emp_sub_role_appr != "CRM - Head"){echo "style='display:none;'";}?>>
...
<?php
	...
	if($emp_sub_role_appr == "CRM - Head"){
		if(empty($complaint_reg->cna_crm_head)){
			echo "<div align='center'><span class='err_msg approval_note_msg'></span></div>
		...
		if(empty($complaint_reg->cna_commercial_head)){
			echo "<div align='center'><span class='err_msg approval_note_msg'></span></div>
			<div class='form-p-box form-p-boxbtn'>
				<button type='button' class='fpcl' data-dismiss='modal'>Close</button>
				<input type='submit' id='approve_approval_note' name='approve_approval_note' class='fpdone' value='Approve' />
		...
		if(empty($complaint_reg->cna_plant_chief)){
			echo "<div align='center'><span class='err_msg approval_note_msg'></span></div>
			<div class='form-p-box form-p-boxbtn'>
				<button type='button' class='fpcl' data-dismiss='modal'>Close</button>
				<input type='submit' id='approve_approval_note' name='approve_approval_note' class='fpdone' value='Approve' />
		...
		if(empty($complaint_reg->cna_sales_head)){
			echo "<div align='center'><span class='err_msg approval_note_msg'></span></div>
			<div class='form-p-box form-p-boxbtn'>
				<button type='button' class='fpcl' data-dismiss='modal'>Close</button>
				<input type='submit' id='approve_approval_note' name='approve_approval_note' class='fpdone' value='Approve' />
		...
		if(empty($complaint_reg->cna_cfo)){
			echo "<div align='center'><span class='err_msg approval_note_msg'></span></div>
			<div class='form-p-box form-p-boxbtn'>
				<button type='button' class='fpcl' data-dismiss='modal'>Close</button>
				<input type='submit' id='approve_approval_note' name='approve_approval_note' class='fpdone' value='Approve' />
...
<!-- Hid this code on 6 Feb 2020 for testing bug <script src="assets/js/app.min.js"></script> -->
...
<script type="text/javascript">
	...
	$("form").submit(function(e) {
		...
		total_qty_rejc = total_qty_rejc.replace("KG","");
		total_qty_rejc = total_qty_rejc.replace("Each","");
		
		qty_acpt_steel_mill 			= $("#qty_acpt_steel_mill").val();
		qty_acpt_steel_mill = qty_acpt_steel_mill.replace("MT","");
		qty_acpt_steel_mill = qty_acpt_steel_mill.replace("KG","");
		qty_acpt_steel_mill = qty_acpt_steel_mill.replace("Each","");

		qty_scrp_auc_serv_cent = $("#qty_scrp_auc_serv_cent").val();
		qty_scrp_auc_serv_cent = qty_scrp_auc_serv_cent.replace("MT","");
		qty_scrp_auc_serv_cent = qty_scrp_auc_serv_cent.replace("KG","");
		qty_scrp_auc_serv_cent = qty_scrp_auc_serv_cent.replace("Each","");

		qty_dlv_customer 				= $("#qty_dlv_customer").val();
		qty_dlv_customer = qty_dlv_customer.replace("MT","");
		qty_dlv_customer = qty_dlv_customer.replace("KG","");
		qty_dlv_customer = qty_dlv_customer.replace("Each","");
		...
		$(".app_note_number").each(function() {			
			...
			app_note_number = app_note_number.replace("KG","");
			app_note_number = app_note_number.replace("Each","");
		...
		total_qty_rejc = total_qty_rejc.replace(/[^\d.]/g, '')
