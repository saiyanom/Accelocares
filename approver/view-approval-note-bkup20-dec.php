...
<div class="form-p-hd">
<h2>Credit Note Approval MIL/MSSCL/MASL</h2>
</div>
...
<div class="rst-full">
	<ul class="fpall">
		...
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->basic_sale_price; ?>" id="basic_sale_price" name="basic_sale_price" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Sales Value (Basic sale price/t X Qty) <span style="float: right;">(a)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->sales_value; ?>" id="sales_value" name="sales_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="number" step=".01" min="0" class="form-control cgst" value="<?php echo 100 / ($approval_note->sales_value/$approval_note->cgst); ?>">
				<div class="input-group-append">
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->cgst; ?>" id="cgst" name="cgst" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="number"step=".01"  min="0" class="form-control sgst" value="<?php echo 100 / ($approval_note->sales_value/$approval_note->sgst); ?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
			</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->sgst; ?>" id="sgst" name="sgst" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10">(+) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->cost_inc_customer; ?>" id="cost_inc_customer" name="cost_inc_customer" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->salvage_value; ?>" id="salvage_value" name="salvage_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->credit_note_iss_cust; ?>" id="credit_note_iss_cust" name="credit_note_iss_cust" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
</div>
...
<div class="rst-full">
	...
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->debit_note_sal_rate_sale_value; ?>" id="debit_note_sal_rate_sale_value" name="debit_note_sal_rate_sale_value" class="form-control form-p-box-bg2 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Value (purchase price/t  X qty) <span style="float: right;">(b)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->value; ?>" id="value" name="value" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="number" step=".01" min="0" class="form-control loss_cgst" value="<?php echo 100 / ($approval_note->value/$approval_note->loss_cgst); ?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
			</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->loss_cgst; ?>" id="loss_cgst" name="loss_cgst" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
			<div class="input-group" style="width: 200px">
				...
				<input <?php echo $readonly; ?> type="number" step=".01" min="0" class="form-control loss_sgst" value="<?php echo 100 / ($approval_note->value/$approval_note->loss_sgst); ?>">
				<div class="input-group-append">
					<span class="input-group-text">%</span>
				</div>
			</div>
		...
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->loss_sgst; ?>" id="loss_sgst" name="loss_sgst" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Total Debit Value  <span style="float: right;">(x)</span></p></li> 
		<li class="fp-con02"><span class="padd10">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->total_debit_value; ?>" id="total_debit_value" name="total_debit_value" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01">
		...
		<li class="fp-con02"><span class="padd10">(+) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->oth_exp_inc_mill; ?>" id="oth_exp_inc_mill" name="oth_exp_inc_mill" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->oth_exp_debited; ?>" id="oth_exp_debited" name="oth_exp_debited" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Compensation expected from Insurance Co. <span style="float: right;">(d)</span></p></li> 
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->compensation_exp; ?>" id="compensation_exp" name="compensation_exp" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		...
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->debit_note_iss_supplier; ?>" id="debit_note_iss_supplier" name="debit_note_iss_supplier" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p class="colrred">Loss from the Rejection <span style="float: right;">(e) = (a-b+c-d-y)</span></p></li> 
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->loss_from_rejection; ?>" id="loss_from_rejection" name="loss_from_rejection" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p>Recoverable from Transporter (if applicable) <span style="float: right;">(f)</span></p></li> 
		<li class="fp-con02"><span class="padd10">(-) &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->recoverable_transporter; ?>" id="recoverable_transporter" name="recoverable_transporter" class="form-control form-p-box-bg1 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
	<ul class="fpall">
		<li class="fp-con01"><p class="colrred">Net Loss / (-) Net Profit <span style="float: right;">(e-f)</span></p></li> 
		<li class="fp-con02"><span class="padd10 colrred">&nbsp; &nbsp; &nbsp; &nbsp; Rs.</span>  
		<input <?php echo $readonly; ?> type="number" step=".01" value="<?php echo $approval_note->net_loss; ?>" id="net_loss" name="net_loss" class="form-control form-p-box-bg3 sphf app_note_number"></li>
		<div class="clerfix"></div>
	</ul>
