...
<?php
	...
	foreach ($emp_location as $emp_location) {
		...
		if($emp_sub_role_header == "CRM - Head" || $emp_sub_role_header == "Commercial Head" || $emp_sub_role_header == "Plant Chief - AN" || $emp_sub_role_header == "Sales Head" || $emp_sub_role_header == "CFO"|| $emp_sub_role_header == "MD" ){
			$emp_sub_role_approval = "Yes";
		} 
		
		if($emp_sub_role_header == "Quality Assurance" || $emp_sub_role_header == "Plant Head" || $emp_sub_role_header == "Plant Chief - CN" || $emp_sub_role_header == "Management Representative" ){
...
<ul class="side-nav-second-level" aria-expanded="false">
	<li><?php
		if(strtolower($employee_reg->emp_email) == "mehernosh.percy@mahindra.com" || strtolower($employee_reg->emp_email) == "salvi.suvarna@mahindra.com" || strtolower($employee_reg->emp_email) == "issar.sumit@mahindra.com" || strtolower($employee_reg->emp_email) == "arora.vijay@mahindra.com"){
			echo "<a href='customer-cvc.php'>Custoer CVC</a>";
		} else {
			echo "<a href='my-cvc.php'>My CVC</a>";
		}
	?></li>
