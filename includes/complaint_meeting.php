...
class ComplaintMeeting extends DatabaseObject {
	
	protected static $table_name="complaint_meeting";
	protected static $db_fields = array('id', 'emp_id', 'emp_name', 'complaint_id', 'customer_id', 'company_name', 'ticket_no', 'request_visit', 'r_visit_remark', 'meeting_date', 'place', 
	'customer_coordinator', 'mobile', 'email', 'cancel_remark', 'visit_done', 'date_', 'time_');
	...
	public $r_visit_remark;
	public $meeting_date;
	public $place;

	public $career_objective;
	public $customer_coordinator;
	public $mobile;
