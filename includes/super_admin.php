...
class SuperAdmin extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'admin_name', 'admin_email', 'admin_mobile', 'admin_role', 'password', 'pass_code', 'status', 'date_', 'time_', 'log', 'log_session', 'log_time');
	...
	/*public static function authenticate($username="", $password="") {
		...
		$sql .= " WHERE admin_email = '{$username}' ";
	...
	public static function authenticate_admin_email($admin_email) {
		$result_array = self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE admin_email='{$admin_email}' LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
	}
