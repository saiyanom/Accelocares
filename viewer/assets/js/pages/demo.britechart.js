...
! function(e, t) {
    ...
    t.createBarChart = function(e, t) {
        ...
        a.colorSchema(["#b6f572", "#727cf5", "#0acf97", "#6c757d", "#e3eaef", "#727cf5", "#0acf97", "#6c757d", "#fa5c7c", "#ffbc00", "#39afd1"]).isAnimated(!0).isHorizontal(!0).width(n).margin({
            top: 10,
            left: 50,
            bottom: 20,
            right: 10
        ...
        l.width(250).height(200).colorSchema(["#727cf5", "#0acf97", "#6c757d", "#fa5c7c", "#ffbc00", "#39afd1", "#39afd1"]).numberFormat("s"), a.height(300).highlightSliceById(3).colorSchema(["#727cf5", "#0acf97", "#6c757d", "#fa5c7c", "#ffbc00", "#39afd1"]).hasFixedHighlightedSlice(!0).internalRadius(80).on("customMouseOver", function(e) {
